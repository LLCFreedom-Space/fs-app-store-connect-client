...
/**
 ...
 - Note:
   This struct provides a convenient way to represent release information, including version and App Store state.
 */
public struct Release {
    ...
    /**
        ...
        - Note:
          This initializer extracts the version string and App Store state from the provided schema and constructs a `Release` instance.

        - Warning:
          If the schema does not contain valid version or state information, the initialization will fail.
        */
